...
if (-not $validRecord) { throw "content.md fixture was not discovered." }
...
Write-Output "Folder metadata tests passed: content.md, safe folder links and missing metadata."
